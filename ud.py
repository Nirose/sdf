...
class Udemy:
    ...
    def cleanDesc(self, title: str, des: str, img: str, link: str):
        ...
        <br>\
            {des}\
<br><br>\
<a href='#' class='bbc_link' target='_blank' rel='noopener noreferrer nofollow'><img loading='lazy' src='https://www.jucktion.com/forum/uploads/enroll-udemy.png' alt='Link to enroll in {alt}' class='bbc_img resized'></a><a href='https://www.jucktion.com/forum/udemy-coupon/?utm_source=forum&amp;utm_campaign=more-udemy-coupons' class='bbc_link' target='_blank' rel='noopener noreferrer nofollow'><img loading='lazy' src='https://www.jucktion.com/forum/uploads/more-udemy-coupons.png' alt='Check more free udemy coupons' class='bbc_img resized linker'></a>\
